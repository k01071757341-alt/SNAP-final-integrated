...
아래는 앱 구현에 사용한 [모바일 디자인 스토리보드](mobile/assets/storyboard/tesla-theme)의 Light/Dark 예시다. 실제 실행 캡처가 아니며, 앱의 숫자와 주차면 상태는 Gateway 데이터로 갱신된다.

<p>
  <img src="mobile/assets/storyboard/tesla-theme/04-parking-progress-light.png" alt="S.N.A.P 주차 진행 Light 디자인 스토리보드" width="260" />
  <img src="mobile/assets/storyboard/tesla-theme/04-parking-progress-dark.png" alt="S.N.A.P 주차 진행 Dark 디자인 스토리보드" width="260" />
</p>
